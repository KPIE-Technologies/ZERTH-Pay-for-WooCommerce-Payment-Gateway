...
class Zerthpay_Gateway_Loader {
	...
	private function hooks() {
		...
		// WordPress Team Ask us to comment this line below. Reason = As there is no load_plugin_textdomain function exists on class it throws fatal error.
	 ...
	 */
	/*
	WordPress Team Asked us to Comment the function below when you want to submit APP for LIVE WP Plugin
	*/
