...
public function init_form_fields() {
    $this->form_fields = array(
        ...
        'api_key' => array(
            'title'       => __( 'ZERTH Pay Public Key', 'zerth-pay-gateway' ),
            'type'        => 'password', // Using password type for sensitive keys
            'description' => __( 'Enter your ZERTH Pay Merchant Public API Key. This can be found on your API settings page on the ZERTH Pay Merchant Dashboard.', 'zerth-pay-gateway' ),
            'default'     => '',
            'desc_tip'    => true,
        ),
        'secret_key' => array(
            ...
            'type'        => 'password', // Using password type for sensitive keys
            'description' => __( 'Enter your ZERTH Pay Merchant Secret Key. This can be found on your API settings page on the ZERTH Pay Merchant Dashboard.', 'zerth-pay-gateway' ),
            'default'     => '',
            'desc_tip'    => true,
        ),
        'test_mode' => array(
...
private function call_zerth_pay_api( $endpoint, $payload ) {
    ...
    $headers = array(
        ...
        'Authorization' => 'Bearer '. $bearer_token, // ZERTH Pay uses Bearer token gotten from the exchange API Key for token endpoint
